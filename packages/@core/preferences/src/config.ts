...
const defaultPreferences: Preferences = {
  ...
  widget: {
    fullscreen: true,
    fullscreenButtonPosition: 'user-dropdown',
    globalSearch: true,
    ...
    notification: true,
    notificationButtonPosition: 'user-dropdown',
    refresh: true,
    refreshButtonPosition: 'user-dropdown',
    sidebarToggle: true,
    themeToggle: true,
    themeToggleButtonPosition: 'user-dropdown',
    timezone: true,
