  ...
  <Page auto-content-height>
    <div v-loading="loading" class="p-4">
      ...
      <div class="mb-4 flex items-center gap-3">
        <div
          class="flex h-12 w-12 shrink-0 items-center justify-center rounded-md border border-solid border-[var(--el-border-color-lighter)] bg-[var(--el-fill-color-light)] text-[var(--el-color-primary)]"
        >
          <IconifyIcon :icon="project.icon || 'ep:folder'" :size="30" />
        </div>
        <div class="min-w-0">
      ...
      <ElTabs v-model="activeTab" @tab-change="handleTabChange">
        ...
        <ElTabPane label="成员" lazy name="member">
          <ProjectMemberList
            v-if="project.id"
            :editable="editable"
            :project="project"
        ...
        <ElTabPane label="项目公告" lazy name="announcement">
        ...
        <ElTabPane label="协作配置" name="configuration">
