...
<template>
  <Modal :title="dialogTitle">
    <div class="max-h-[70vh] overflow-y-auto pr-2">
      ...
      >
        <!-- 基本信息 -->
        <FormItem :label="`${workItemTypeName}标题`" name="name">
          <Input
        ...
        <Row :gutter="20">
          ...
          <Col :span="12">
            <FormItem label="负责人" name="assigneeUserId">
              <ProjectMemberSelect
        ...
        <Row :gutter="20">
          ...
          <Col :span="12">
            <FormItem label="截止时间" name="endTime">
              <DatePicker
        ...
        <Row :gutter="20">
          <Col v-if="projectType === PmsProjectType.AGILE" :span="12">
            <FormItem label="所属迭代" name="iterationId">
              <IterationSelect
          ...
          <Col :span="projectType === PmsProjectType.AGILE ? 12 : 24">
            <FormItem label="父级工作项" name="parentId">
              <WorkItemSelect
        ...
        >
          <Col :span="12">
            <FormItem label="关联需求" name="relatedRequirementId">
              <WorkItemSelect
          ...
          <Col v-if="type === PmsWorkItemType.DEFECT" :span="12">
            <FormItem label="缺陷类型" name="defectType">
              <Select
        ...
        <Row :gutter="20">
          ...
          <Col :span="12">
            <FormItem label="完成进度" name="progress">
        ...
        <FormItem label="参与人" name="memberUserIds">
          <ProjectMemberSelect
        ...
        <FormItem label="标签" name="labelIds">
        ...
        <FormItem :label="`${workItemTypeName}描述`" name="description">
        ...
        <template v-if="formType === 'create'">
          ...
          <Row :gutter="20">
            <Col :span="12">
              <FormItem label="实际投入" name="actualHours">
                <InputNumber
            ...
            <Col :span="12">
              <FormItem label="剩余工时" name="remainingHours">
                <InputNumber
